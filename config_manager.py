    ...
    "builder_base": {
        "entry": {
            ...
            "stage2_to_stage1_swipes": [
                [1200, 700, 400, 200, 700],
                [1200, 700, 400, 200, 700],
                [1200, 700, 400, 200, 700],
            ],
            "boat_template_dir": "img/builder/boat",
            "return_boat_template_dir": "img/builder/return_boat",
            "boat_match_threshold": 0.62,
            "return_boat_match_threshold": 0.68,
            "return_boat_search_region": [900, 250, 700, 650],
            "boat_search_attempts": 3,
            "return_zoom_out_count": 4,
            "travel_wait_seconds": 8.0,
        },
        "coords": {
            "attack": [105, 795],
            "find_now": [1190, 592],
            "start_dialog_close": [1360, 165],
            "end_battle": [115, 625],
            "return_home": [800, 760],
            "star_bonus_okay": [800, 700],
            "hero_slot": [162, 812],
            "troop_slots": [
                [305, 812],
                [432, 812],
        ...
        "deploy": {
            "stage1_zone": [],
            "stage2_zone": [],
            "stage1_zoom_out_count": 3,
            "stage2_zoom_out_count": 3,
            "camera_settle_seconds": 0.8,
            "random_points": 64,
            "point_spacing_min_px": 20,
            "point_spacing_max_px": 45,
            "troop_delay_seconds": 0.5,
            "slot_scan_attempts": 3,
            "slot_scan_delay_seconds": 0.35,
            "hero_deploy_attempts": 2,
            "hero_deploy_verify_seconds": 0.8,
            "troop_skill_delay_seconds": 3.0,
            "hero_first_skill_delay_seconds": 28.0,
            "hero_repeat_skill": True,
            "hero_ready_poll_seconds": 2.0,
            "hero_repeat_min_seconds": 15.0,
        },
        "elixir_cart": {
            "enabled": True,
            "collect_every_n_attacks": 1,
            "icon_search_attempts": 3,
            "icon_template_dir": "img/builder/elixir-cart/icon",
            "popup_template_dir": "img/builder/elixir-cart/popup",
            "icon_match_threshold": 0.76,
            "popup_match_threshold": 0.82,
            "reward_region": [850, 185, 190, 55],
            "collect_button": [1175, 760],
            "close_button": [1342, 88],
            "open_wait_seconds": 1.0,
            "collect_wait_seconds": 1.0,
        },
        "wall_upgrade": {
            "enabled": False,
            "dry_run": False,
            ...
            "resource_regions": {
                "gold": [1280, 15, 285, 60],
                "elixir": [1280, 95, 285, 60],
            },
            "confirmation_region": [420, 210, 760, 300],
            "confirmation_cost_region": [690, 365, 480, 85],
            "coords": {
                "builder_icon": [840, 50],
                "add1_button": [800, 700],
                "remove_button": [446, 700],
                "upgrade_gold_button": [980, 700],
                "upgrade_elixir_button": [1155, 700],
                "confirm_okay_button": [973, 580],
                "confirm_cancel_button": [622, 580],
            },
        },
        "timing": {
            "after_attack_seconds": 1.5,
            "after_find_now_seconds": 6.0,
            "attack_cooldown_retry_seconds": 15.0,
        ...
        "ocr_regions": {
            ...
            "damage_percent": [1450, 630, 135, 70],
            "battle_activity": [250, 120, 1100, 500],
            "result_damage": [690, 335, 230, 105],
            "result_gold": [930, 532, 150, 42],
            "result_trophies": [920, 590, 235, 70],
            "return_home_button": [680, 710, 245, 105],
            "star_bonus_title": [550, 120, 500, 120],
            "star_bonus_panel": [250, 130, 1100, 660],
            "star_bonus_okay_button": [650, 640, 300, 130],
            "start_attack_title": [500, 100, 600, 120],
            "find_now_button": [1025, 520, 330, 140],
            "builder_attack_button": [20, 710, 175, 175],
        },
    },
}
